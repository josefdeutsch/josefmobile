package com.josef.mobile.ui.main.post.content.third;
...
import static com.josef.mobile.utils.AppConstants.THIRD;

public class ThirdPostFragmentViewModel extends BaseViewModel {
    ...
    @Inject
    public ThirdPostFragmentViewModel(DataManager dataManager,
    ...
    public LiveData<Resource<List<Container>>> observeEndpoints() {
        ...
        LiveData<Resource<List<Container>>> source =
                LiveDataReactiveStreams.fromPublisher(endpointsObserver.getEndpoints(THIRD));
