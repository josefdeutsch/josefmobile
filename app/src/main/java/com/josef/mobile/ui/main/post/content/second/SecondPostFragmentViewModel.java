...
import static com.josef.mobile.utils.AppConstants.SECOND;

public class SecondPostFragmentViewModel extends BaseViewModel {
    ...
    @Inject
    public SecondPostFragmentViewModel(DataManager dataManager,
    ...
    public LiveData<Resource<List<Container>>> observeEndpoints() {
        ...
        LiveData<Resource<List<Container>>> source =
                LiveDataReactiveStreams.fromPublisher(endpointsObserver.getEndpoints(SECOND));
