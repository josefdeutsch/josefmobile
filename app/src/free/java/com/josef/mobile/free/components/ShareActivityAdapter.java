...
public class ShareActivityAdapter extends RecyclerView.Adapter<ShareActivityAdapter.ViewHolder> {
    ...
    public ShareActivityAdapter(Context context, ArrayList<String> items) {
        mContext = context;
        mValues = items;
    }
